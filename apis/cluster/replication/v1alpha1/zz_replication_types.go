...
type ReplicationInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/thisisnttheway/provider-harbor/apis/cluster/project/v1alpha1.Project
	...
	// +crossplane:generate:reference:type=github.com/thisisnttheway/provider-harbor/apis/cluster/registry/v1alpha1.Registry
